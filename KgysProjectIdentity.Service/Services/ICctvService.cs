...
namespace KgysProjectIdentity.Service.Services
{
    public interface ICctvService
    {
        ...
        bool CctvPictureRemove(CctvProjectPictureModel project, string UserName);
        bool EbysNumberAdd(CctvViewModel project, string UserName);
        bool EbysNumberRemove(CctvEbysNumbersModel ebys, CctvModel detail, string UserName);
    }
}
